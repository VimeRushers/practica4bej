...
<head>
    ...
    <title>Conectare - QGroup Investment</title>
            ...
            <div class="user-menu">
                ...
                @else
                    <div class="auth-buttons">
                        <a href="{{ route('auth.login') }}" class="auth-btn login-btn active">
    ...
    <div class="main-content">
        <div class="left-section">
            <div class="hero-content">
                <h1>
                    Investește în
                    <span class="highlight">Viitorul</span>
                    Moldovei
                </h1>
                <p>
                    Descoperă oportunități de investiții inovatoare în sectoarele cu cel mai mare potențial de creștere. 
                    Platforma noastră oferă acces la proiecte exclusive și analize detaliate pentru decizii informate.
                </p>
        ...
        <div class="right-section">
            <div class="login-container">
                <div class="login-header">
                    ...
                    <p class="subtitle">Accesează panoul de administrare</p>
                </div>
